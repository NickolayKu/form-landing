      ...
      <div className="container">
        <div className={cls.homeProjects}>
          {projectsCards.map((item, index) => {
            return <ProjectCard key={index} image={item.image} title={item.title} tags={item.tags} link={item.link}/>
          })}
        </div>
      </div>
  )
