      ...
      <section>
        <ul>
          ...
          <li>
            ...
            <p style={{marginBottom: 0}}>Старый прайс-лист не отвечал современным требованиям пользователей. Количество арен растет, конфигураций становится все больше. Мы разработали гибкий прайс-лист, адаптируемый под клуб любого размера, начиная от одной и заканчивая шестью зонами для игр.</p>
          </li>
        </ul>
      </section>
      <section>
