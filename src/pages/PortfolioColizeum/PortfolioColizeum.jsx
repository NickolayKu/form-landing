...
export default function PortfolioColizeum() {
  ...
  const projectData = {
    ...
    text: 'Colizeum - крупнейшая сеть киберспортивных клубов в мире и самый известный бренд среди геймеров, формирующий новый подход к игровому пространству. Всего открыто более 430 клубов Colizeum в 19 странах.',
